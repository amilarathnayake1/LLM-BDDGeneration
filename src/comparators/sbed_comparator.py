...
from config import SBEDConfig

class SBEDComparator(BaseComparator):
    def __init__(self, config: SBEDConfig):
        """Initialize the SentenceBERT with Euclidean Distance comparator"""
        self.config = config
    ...
    def _calculate_similarity(self, text1: str, text2: str) -> float:
        """Calculate similarity using Euclidean distance between SentenceBERT embeddings"""
        # Generate embeddings
        ...
        distance = euclidean(embedding1_np[0], embedding2_np[0])
        ...
        if self.config.normalize_distance:
            ...
            # Return raw distance (lower is better)
    ...
    def compare_scenarios(self, 
        ...
        """Compare AI-generated and manual scenarios using SentenceBERT and Euclidean Distance"""
    ...
    def _print_comparison_details(self, ai_steps: List[str], manual_steps: List[str]) -> None:
        ...
        print("\nStep Comparison Details (SentenceBERT + Euclidean Distance):")
        print("-" * 80)
